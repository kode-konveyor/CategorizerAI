...
class Test(unittest.TestCase):
    ...
    def setUp(self):
        with\
                ...
                unittest.mock.patch('keras.Sequential') as self.model:
            self.result = neuralNetBuilderService().buildNeuralNet(self.dataTestData.MAX_LENGTH, self.dataTestData.OUTPUT_NEURONS )
